...
Example: 
User prompt: I want a designer ballgown in size XXS with max price 5, Example wardrobe
Output for listing: No listings matched your search. Try different keywords, a larger size range, or a higher price limit.
Outfit idea and Your fit card are blank
...
The spec helped me understand what this project is about more and forced me to look at the different files before implementing anything.
...
- *What I gave the AI:* I told Claude to implement the code for the tools in tools.py and gave it the documentation with the functions as well as the inputs, outputs, and edge cases that were in my planning.md file. 
- *What it produced:* Claude produced code that follows the code documentation as well as my spec.
- *What I changed or overrode:* N/A
**Instance 2**

- *What I gave the AI:* I told Claude to implement the run_agent() function in agent.py that takes in a user's query and returns a session dict based on that query
